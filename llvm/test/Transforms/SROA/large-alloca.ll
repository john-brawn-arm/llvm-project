...
define i32 @store_inside_store_large_alloca(i64 %x, i16 %y) {
; CHECK-LABEL: define i32 @store_inside_store_large_alloca(
; CHECK-SAME: i64 [[X:%.*]], i16 [[Y:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[ALLOCA_SROA_0_SROA_2_0_INSERT_EXT:%.*]] = zext i16 [[Y]] to i32
; CHECK-NEXT:    [[ALLOCA_SROA_0_SROA_2_0_INSERT_SHIFT:%.*]] = shl nuw i32 [[ALLOCA_SROA_0_SROA_2_0_INSERT_EXT]], 16
...
define i512 @store_inside_store_large_alloca_large_types(i1024 %x, i256 %y) {
; CHECK-LABEL: define i512 @store_inside_store_large_alloca_large_types(
; CHECK-SAME: i1024 [[X:%.*]], i256 [[Y:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
