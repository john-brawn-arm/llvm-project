...
; CHECK:       [[FOR_BODY29]]:
; CHECK-NEXT:    [[I24_0170:%.*]] = phi i16 [ 0, %[[ENTRY]] ], [ [[INC37:%.*]], %[[FOR_BODY29]] ]
...
; PGSO:       [[FOR_BODY29]]:
; PGSO-NEXT:    [[I24_0170:%.*]] = phi i16 [ 0, %[[ENTRY]] ], [ [[INC37:%.*]], %[[FOR_BODY29]] ]
...
; NPGSO:       [[FOR_BODY29]]:
; NPGSO-NEXT:    [[I24_0170:%.*]] = phi i16 [ 0, %[[ENTRY]] ], [ [[INC37:%.*]], %[[FOR_BODY29]] ]
...
; NPGSO-NEXT:    br i1 [[TMP5]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP19:![0-9]+]]
; NPGSO:       [[MIDDLE_BLOCK]]:
...
; CHECK-NEXT:    br i1 [[EXITCOND]], label %[[FOR_END]], label %[[FOR_BODY]], !llvm.loop [[LOOP18:![0-9]+]]
; CHECK:       [[FOR_END]]:
; CHECK-NEXT:    ret void
;
...
; PGSO-NEXT:    br i1 [[TMP8]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP15:![0-9]+]]
; PGSO:       [[MIDDLE_BLOCK]]:
...
; PGSO-NEXT:    br i1 [[EXITCOND]], label %[[FOR_END]], label %[[FOR_BODY]], !llvm.loop [[LOOP18:![0-9]+]]
; PGSO:       [[FOR_END]]:
; PGSO-NEXT:    ret void
;
...
; NPGSO-NEXT:    br i1 [[EXITCOND]], label %[[FOR_END]], label %[[FOR_BODY]], !llvm.loop [[LOOP24:![0-9]+]]
; NPGSO:       [[FOR_END]]:
; NPGSO-NEXT:    ret void
;
...
; CHECK: [[LOOP20]] = distinct !{[[LOOP20]], [[META16]]}
;.
...
; PGSO: [[LOOP20]] = distinct !{[[LOOP20]], [[META16]]}
;.
...
; NPGSO: [[LOOP20]] = distinct !{[[LOOP20]], [[META16]]}
